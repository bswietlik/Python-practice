#Medical Insurance Project- excercises from class
...
class Patient:
    ...
    def estimated_insurance_cost(self):
        ...
        print(self.name + " 's estimated isurance costs is " + str(estimated_cost) + " dollars.")
    ...
    def patient_profile(self):
        ...
        patient_information["Num of children"] = self.num_of_children
